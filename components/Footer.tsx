...
function Footer() {
  ...
  return (
    <footer className='w-full h-80 md:h-60 px-10'>
        <div className='w-full flex flex-col md:flex-row md:items-center justify-around'>
            ...
            <ul>
                <li className='text-white font-light hover:text-green-400 transition-colors'>
                    <a href="#home">Home</a>
                </li>
                <li className='text-white font-light hover:text-green-400 transition-colors'>
        ...
        <div className='w-full flex items-center gap-4 justify-center mt-4'>
            <a className='text-white border p-2 border-white rounded-full flex items-center justify-center transition-colors hover:border-[#AAD5C2] hover:text-[#AAD5C2]' href="https://www.instagram.com/italociruvet/">
